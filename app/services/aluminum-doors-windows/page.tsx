    ...
    <>
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden mt-20">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-5xl mx-auto">
          ...
          >
            Aluminum Doors & <span className="text-luxury-gold-500">Windows</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <Section background="white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-luxury-charcoal-900 mb-2">{feature.title}</h3>
        ...
        <div className="bg-gray-50 rounded-lg p-8">
          <h3 className="text-3xl font-serif font-bold text-luxury-charcoal-900 mb-6 text-center">Product Range</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {products.map((product) => (
              <div key={product} className="flex items-center">
                <svg className="w-5 h-5 text-luxury-gold-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
