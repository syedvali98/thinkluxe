    ...
    <>
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-5xl mx-auto">
          ...
          >
            About <span className="text-brand-bronze-500">Think LUXE</span>
          </motion.h1>
        </div>
      </section>
      ...
      <Section background="white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-brand-charcoal-500 font-light leading-relaxed mb-8">
      ...
      <Section background="gray">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-brand-charcoal-900 mb-4">
            Our Values
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-center card-luxury p-6 rounded-lg"
            >
              <div className="flex justify-center mb-4">{value.icon}</div>
              <h3 className="text-2xl font-light text-brand-charcoal-900 mb-3">{value.title}</h3>
              <p className="text-brand-charcoal-500 font-light">{value.description}</p>
            </motion.div>
          ))}
        </div>
      </Section>
      ...
      <Section background="white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-brand-charcoal-500 font-light leading-relaxed mb-6">
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-start text-brand-charcoal-600 font-light">
                <svg className="w-6 h-6 mr-3 text-brand-bronze-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
