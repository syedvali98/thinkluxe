...
const doorTypes = [
  {
    ...
    productOptions: [
      ...
      },
      {
        ...
        description:
          "A variety of glass color and type options allow you to add unique details to your doors while balancing the privacy and natural light you prefer and delivering superior quality and thermal performance.",
      },
      {
        id: "hardware",
        name: "Hardware",
        title: "Hardware Options",
        image: "/images/hardware-product-7.png",
        description:
  ...
  },
  {
    ...
    image: "/images/bi-folding-doors.jpg",
    description: [
    ...
    productOptions: [
      ...
      },
      {
        ...
        description:
          "Our built-in blind options allow the blinds to be tilted and raised via a magnetic handle, wall switch, or remote control and are permanently sealed inside double-glazed doors. The louver design is hidden between insulated glass panels, allowing for minimal cleaning and no fear of damage, making it safer for your children and pets.",
      },
    ],
  },
  {
    ...
    description: [
      "French doors are classically functional, swinging inward or outward to provide a wide opening that works for almost any space, indoors or out. We offer a variety of configurations and materials for French doors, allowing you to customize their performance and appearance to create an elegant, timeless look for your home, inside and out.",
      "Available in right hinge, left hinge, inward opening and outward opening configurations. Wide range of door glass options including stained glass, decorative glass, grilles and internal shutters. Passed rigorous industry testing standards and certified to withstand heavy daily use. Multi-point locking hardware secures door in multiple locations for added security. Virtually unlimited customization with a variety of sizes, designs and configuration options. Well-built and precision-engineered for years of reliable service with virtually no maintenance",
    ],
    productOptions: [
      {
        id: "materials",
...

  {
    ...
    name: "Hinged",
    title: "Hinged Doors",
    image: "/images/hinged-doors.png",
    description: [
      "Single-leaf hinged doors are the most common type of door for interior building decoration. These doors are hinged and can open inwards or outwards, providing an elegant entrance solution for indoor and outdoor spaces. No matter what aesthetic you prefer traditional wood or sleek aluminum we can customize your hinged door with a variety of high-quality materials and finishes.",
      "Multiple locking points on hinged doors can provide an extra layer of protection for your space and help keep out unwanted visitors.",
      "Durable, extruded aluminum on the outside of the frame and panels helps to ensure long-lasting beauty. Can be configured to open in or out, to the left or right.Slender frames paired with larger areas of glass allow for the maximum amount of natural light to enter your home. Energy efficient design can help you save money and keep you comfortable to live in. Customizable in width and height and available in different styles.",
    ],
    productOptions: [
      {
        id: "materials",
      ...
      },
      {
        ...
        name: "Hardware",
        title: "Hardware Options",
        image: "/images/hardware-product-6.png",
        description:
          "Engineered to be both durable and beautiful, our hardware is available in different style design options with finishes that complement our products' hardware for a consistent look.",
      },
    ],
        ...
        <Container className="px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-[#b5b5b5] font-medium text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4 sm:px-0">
              Browse through a variety of door styles to find the best one for
              your home.
            </p>
          </motion.div>
              ...
              <div className="relative p-[1px] rounded-[20px] md:rounded-[30px] lg:rounded-[40px] bg-gradient-to-br from-[#C9A962] via-[#C9A962]/50 to-[#333333] lg:col-span-2">
                <div className="bg-[#0a0a0a] rounded-[20px] md:rounded-[30px] lg:rounded-[40px] p-5 sm:p-6 md:p-10 lg:p-12 h-full flex flex-col justify-center">
                  ...
                  <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                    {doorTypes[selectedTab].description.slice(0, -1).map((para, index) => (
                      <p
                        key={index}
                    ...
                    <ul className="list-disc list-inside space-y-1">
                      {doorTypes[selectedTab].description[doorTypes[selectedTab].description.length - 1]
                        .split('.')
