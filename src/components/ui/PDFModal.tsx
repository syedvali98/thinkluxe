      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className="relative w-full max-w-5xl h-[85vh] bg-[#0a0a0a] rounded-3xl overflow-hidden border border-[#C9A962]/30 shadow-[0_0_50px_rgba(201,169,98,0.15)]"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-6 py-4 bg-gradient-to-b from-[#0a0a0a] via-[#0a0a0a] to-transparent">
              <h3 className="font-serif text-xl md:text-2xl text-[#C9A962]">
                {title}
              </h3>
              <div className="flex items-center gap-3">
                ...
                <a
                  href={pdfUrl}
                  download
                  className="flex items-center gap-2 px-4 py-2 rounded-full border border-[#C9A962]/40 text-[#C9A962] text-sm hover:bg-[#C9A962]/10 transition-colors"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
