...
const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/share/14Z3YR2UQKv/?mibextid=wwXIfr",
    ...
    {
      name: "Google Reviews",
      href: "https://www.google.com/search?hl=en-GB&gl=in&sxsrf=ANbL-n7IHVZkFbno27WqQuNtz0taLZ0sCg:1768343299047&si=AL3DRZEsmMGCryMMFSHJ3StBhOdZ2-6yYkXd_doETEE1OR-qOYrWECYymUDCIJhVVVBXjC9_drQRjTUubVEDhV1_hC_SG9IeITqw43GNtQEx70jEFED0-KuHOyFvG9NpDAH38OD8AgBF&q=Think+Luxe+Reviews&aic=0",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
